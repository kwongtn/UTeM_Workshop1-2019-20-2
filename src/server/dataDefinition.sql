...
-- Create tables
CREATE TABLE `USER` (
    `userID` INT AUTO_INCREMENT UNSIGNED NOT NULL,
...
CREATE TABLE `MEMBER` (
    `memberID` INT AUTO_INCREMENT UNSIGNED NOT NULL,
...
CREATE TABLE `ATTENDANCE` (
    `attendanceID` INT AUTO_INCREMENT UNSIGNED NOT NULL,
    `memberID` INT UNSIGNED NOT NULL,
...
CREATE TABLE `ACTIVITY` (
    `activityID` INT AUTO_INCREMENT UNSIGNED NOT NULL,
    `activityDesc` TEXT,
    `userID` INT UNSIGNED NOT NULL,
